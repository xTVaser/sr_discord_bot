  ...
  module CommandLoader
    module StatsGame
      ...
      command(:statsgame, description: 'Displays stats for a given tracked game',
        ...
        if gameID == nil
          _event << "No game found with that alias, use #{PREFIX}listgames to view current aliases"
          next
        end
        ...
        embed = Discordrb::Webhooks::Embed.new(
          ...
          description: "To View Category Information `#{PREFIX}statscategory categoryAlias`",
          thumbnail: {
            url: game.cover_url
          },
          footer: {
            text: "To View Category Aliases `#{PREFIX}listcategories #{_gameAlias}`\n#{PREFIX}help to view a list of available commands"
          }
        )
        embed.colour = "#1AB5FF"
